...
contextBridge.exposeInMainWorld("academicApi", {
  ...
  confirmExamImport: (token, decisions) => ipcRenderer.invoke("academic:exams-import-confirm", { token, decisions }),
  cancelExamImport: token => ipcRenderer.invoke("academic:exams-import-cancel", token),
  updateExam: (id, patch) => ipcRenderer.invoke("academic:exams-update", { id, patch }),
  deleteExam: id => ipcRenderer.invoke("academic:exams-delete", id),
